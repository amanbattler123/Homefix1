...
$pageTitle = "Contact Us - HomeFix Pro | Get in Touch for Premium Home Services";
$pageDescription = "Contact HomeFix Pro for professional home services in Addis Ababa. Get support, request quotes, or ask questions about our premium services.";
$pageKeywords = "contact us, home services contact, Addis Ababa, support, request quote, customer service";
    ...
    try {
        ...
        if($stmt->execute()) {
            ...
            try {
                ...
                // Enable verbose debug output while testing (comment out in production)
                // $mail->SMTPDebug = 2;
                ...
                // Use TLS with port 587 for Gmail
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                $mail->Port = 587;

                $mail->setFrom('amanuelaman63@gmail.com', 'Contact Form');
                ...
                $mail->Body =
                    ...
                    '<p><strong>Message:</strong><br>' . nl2br(htmlspecialchars($message_text, ENT_QUOTES, 'UTF-8')) . '</p>';

                $mail->send();

                $message = '<div class="alert alert-success">Thank you for your message! We will get back to you soon.</div>';
            } catch (Exception $e) {
                $message = '<div class="alert alert-warning">Your message was saved, but the email notification could not be sent. Mailer Error: ' . htmlspecialchars($mail->ErrorInfo, ENT_QUOTES, 'UTF-8') . '</div>';
            }
        } else {
...
/* Enhanced Contact Hero Section (same style as About page hero) */
.contact-hero {
    min-height: 100vh;
    display: flex;
    align-items: center;
...
<section class="contact-hero">
    <div class="container">
        <div class="hero-content">
            <div class="hero-text">
                ...
                <h1 class="hero-title">
                    Get in <span class="title-accent">Touch</span> With Us
                </h1>
                
                <p class="hero-description">
                    Have questions, need support, or want to request a custom service? Send us a message and our team
                    will respond as soon as possible.
                </p>
                
                <div class="hero-actions">
                    <a href="#contact-form" class="btn btn-primary btn-large scroll-to">
                        <i class="fas fa-envelope"></i>
                        Send Message
                    </a>
                    <a href="#contact-info" class="btn btn-secondary btn-large scroll-to">
    ...
    <div class="scroll-indicator">
        <div class="scroll-text">Scroll to Contact Form</div>
...
<section class="contact-page" id="contact-form">
    <div class="container">
        <div class="section-title">
            <h2>Contact Us</h2>
            <p>Get in touch with our team in Addis Ababa for any inquiries, bookings, or support.</p>
        </div>
        ...
        <div class="contact-content">
            <div class="contact-info" id="contact-info">
                ...
                <div class="contact-item">
                    ...
                    <div>
                        <h4>Phone</h4>
                        <p>+251 11 123 4567</p>
                        <p>+251 91 123 4567 (Mobile / WhatsApp)</p>
                    </div>
                </div>
                <div class="contact-item">
                    <i class="fas fa-envelope"></i>
                    <div>
                        <h4>Email</h4>
                        <p>info@homefixpro.et</p>
                        <p>support@homefixpro.et</p>
                    </div>
                </div>
                <div class="contact-item">
            ...
            <div class="contact-form">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="subject" class="form-control" placeholder="Subject" required value="<?php echo isset($_GET['service']) ? 'Service Inquiry: ' . $_GET['service'] : ''; ?>">
                    </div>
                    <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    gsap.utils.toArray('.contact-item, .contact-form, .section-title').forEach(element => {
        gsap.from(element, {
            scrollTrigger: {
                trigger: element,
                start: 'top 80%',
