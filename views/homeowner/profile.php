...
function buildMediaUrls($profile) {
    return [
...
[$profilePhotoUrl, $residenceIdUrl, $residenceIdFileName] = buildMediaUrls($userProfile);

// Calculate profile completion based on stored data
$homeCompletionItems = 0;
$homeCompletedItems = 0;
...
foreach ($homeRequiredFields as $field) {
    $homeCompletionItems++;
...
foreach ($homeDocumentFields as $field) {
    $homeCompletionItems++;
    if (!empty($userProfile[$field])) {
        $homeCompletedItems++;
    }
...
$homeProfileCompletion = $homeCompletionItems > 0
    ? (int)round(($homeCompletedItems / $homeCompletionItems) * 100)
    : 0;

if ($homeProfileCompletion > 100) {
    $homeProfileCompletion = 100;
}
...
if(isset($_POST['update_profile'])) {
    ...
    $result = $homeownerController->updateProfile($data, $_FILES);
    if($result['success']) {
        ...
        $userProfile = $homeownerController->getUserProfile(); // Refresh profile data
        [$profilePhotoUrl, $residenceIdUrl, $residenceIdFileName] = buildMediaUrls($userProfile);
    } else {
...
if(isset($_POST['change_password'])) {
    ...
    if(empty($current) || empty($new) || empty($confirm)) {
        ...
        $result = $homeownerController->changePassword($current, $new);
        if($result['success']) {
        ...
        <div class="main-content">
            ...
            <div class="stats-container" data-aos="fade-up">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <div class="stat-value" id="completion-stat" style="color:#000;"><?php echo $homeProfileCompletion; ?>%</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <div class="stat-value" style="color:#000;">Verified</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        <div class="stat-value" style="color:#000;">2/3</div>
                        <div class="stat-label" style="color:#000;">Verification Steps</div>
                    </div>
                </div>
            </div>
            <!-- Messages Container -->
            ...
            <div class="card" data-aos="fade-up" data-aos-delay="200">
                <div class="card-header">
                    <div>
                        ...
                        <p class="card-subtitle">Update your personal details and profile information</p>
                    </div>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="profile-form">
                    ...
                    <div class="profile-media">
                        ...
                        <div class="media-item" data-aos="fade-right" data-aos-delay="250">
                            ...
                            <small>JPG, PNG, GIF up to 2MB. Recommended: 300x300px square image.</small>
                        </div>
                        ...
                        <div class="media-item" data-aos="fade-left" data-aos-delay="250">
                            ...
                            <div class="media-preview">
                                <?php if(!empty($userProfile['residence_id_file'])): ?>
                            ...
                            <small>PDF, JPG, PNG up to 5MB. Ensure all text is clearly visible.</small>
                        </div>
                    </div>
                    ...
                    <div class="profile-info">
                        ...
                        <div class="form-group" data-aos="fade-up" data-aos-delay="500">
                            ...
                            <input type="text" name="address" class="form-control" required 
                                   value="<?php echo htmlspecialchars($userProfile['address'] ?? ''); ?>">
                        </div>
                        ...
                        <div class="form-group" data-aos="fade-up" data-aos-delay="550">
                            ...
                            <input type="text" name="subcity" class="form-control" required 
                                   value="<?php echo htmlspecialchars($userProfile['subcity'] ?? ''); ?>">
                        </div>
                        ...
                        <div class="form-group" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <input type="text" name="woreda" class="form-control" required 
                                   value="<?php echo htmlspecialchars($userProfile['woreda'] ?? ''); ?>">
                        </div>
                    </div>
                    
                    <button type="submit" class="btn mt-4" id="update-profile-btn" data-aos="fade-up" data-aos-delay="650">
