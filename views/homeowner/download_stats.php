...
$controller = new HomeownerController($conn);
$details = $controller->getDetailedStats();

$lines = [];
$lines[] = 'Homeowner Statistics Summary';
$lines[] = 'Generated: ' . date('M j, Y g:i A');
$lines[] = '';
$lines[] = 'Services:';
$lines[] = '  Total Requests: ' . $details['services']['total'];
...
$lines[] = '  Total Amount Paid: ETB ' . number_format($details['payments']['total_amount_paid'], 2);
$lines[] = '';
$lines[] = 'Messages:';
...
header('Content-Disposition: attachment; filename="homeowner_statistics.pdf"');
